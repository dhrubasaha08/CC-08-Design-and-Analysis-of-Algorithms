...
Program No:     17
Program Name:   Write a C/C++ program to find all the paths between any two
vertices of a connected graph. Date:           09/06/2022
*********************************************************************************************************/
#include <stdio.h>
#include <stdlib.h>

void printPath(int *path, int path_size);
void printAllPaths(int *path, int path_size, int start, int end, int **graph,
                   int graph_size);
