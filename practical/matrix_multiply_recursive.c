...
Program No:     6
Program Name:   Write a C program to multiply two matrices by recursive
approach. Date:           06/05/2022
***********************************************************************************/
...
int multiplyMat(int **a, int **b, int **c, int ars, int are, int acs, int ace,
                int brs, int bre, int bcs, int bce) {
  if (are - ars == 1) {
